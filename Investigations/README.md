...
| [SOC-006](./web-attacks/SOC-006-lfi-directory-traversal-attempt/) | LFI / Directory Traversal Attempt | Web Attack | High | True Positive — Unsuccessful | T1190 | HTTP analysis, LFI recognition, source-IP enrichment, response-code interpretation, escalation decision |
